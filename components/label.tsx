...
const Label = ({
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center rounded-full border bg-white p-1 text-xs font-semibold text-black backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white">
